...
const projects = [
  {
    ...
    desc: 'Reduced support ticket volume by 74% through an intelligent triage and resolution AI deployed across web and mobile.',
    metric: '74%',
  ...
  },
  {
    ...
    client: 'SAAS_PLATFORM',
    tags: ['ML', 'DATA', 'PREDICTION'],
    desc: 'Built a real-time churn prediction pipeline that increased retention by 31% in the first quarter post-deployment.',
    metric: '+31%',
  ...
  },
  {
    ...
    client: 'LEGAL_TECH',
    tags: ['RAG', 'LLM', 'EXTRACTION'],
    desc: 'Deployed a RAG-based document analysis system that cut contract review time from 4 hours to 12 minutes.',
    metric: '4H→12M',
  ...
  },
  {
    ...
    client: 'MEDIA_AGENCY',
    tags: ['GENERATION', 'WORKFLOW', 'SCALE'],
    desc: 'Automated content generation and QA pipeline producing 10× output with consistent brand voice across all channels.',
    metric: '10×',
    metricLabel: 'OUTPUT SCALE',
  },
]
